...
public class HoodConstants {
    ...
    public static final Angle MIN_ANGLE = Degree.of(0); // Temp
    public static final Angle MAX_ANGLE = Degree.of(90); // Temp

    public static final double MOTOR_KP = 0; // Temp
    ...
    public static final double MOTOR_KS = 0; // Temp
    public static final double MOTOR_KV = 0; // Temp
    public static final double MOTOR_KA = 0; // Temp
    public static final double MOTOR_KG = 0; // Temp

    public static final double GEARING_RATIO = 75; // Temp

    public static final MomentOfInertia MOI = KilogramSquareMeters.of(0.086); // Temp
    public static final Distance LENGTH = Meter.of(0.50); // Temp

...
public class OasisTunerConstants {
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.433837890625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.128173828125);
